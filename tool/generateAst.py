...
def main():
    ...
    defineAst(outputDir, "Expression",
            ...
            ["Variable		= Token name",
			 ...
			 "PointerType	= Token name, bool isMutable, std::unique_ptr<Expression> subtype",
             "NamedType		= Token name, bool isMutable, bool isPointer, std::optional<std::unique_ptr<NamedType>> subtype",
             "Cast			= std::unique_ptr<Expression> expression, NamedType type",
    ...
    defineAst(outputDir, "Statement",
            ...
            ["Block			= std::vector<std::unique_ptr<Statement>> statements",
             ...
             "Function		= Token name, bool publicVisibility, std::vector<Parameter> params, std::optional<Block> body, NamedType returnType",
             ...
             "VarDecl		= Token name, NamedType type, bool is_mutable, std::optional<std::unique_ptr<Expression>> initializer",
             "Member		= Token name, NamedType type, bool is_mutable, std::optional<std::unique_ptr<Expression>> initializer",
