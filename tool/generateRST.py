...
def defineRST(outputDir: str, baseName: str, namespace: str, requiredHeaders: list[str], definitions: list[str], types: list[str]):
...
def main():
    outputDir = "./RayC/include/ray/compiler/syntax/rst"
    defineRST(outputDir, "Expression", "ray::compiler::syntax::rst",
        ["ray/compiler/syntax/common/intrinsic.hpp", "memory", "vector"],
        [],
        ["Variable		= Token name",
